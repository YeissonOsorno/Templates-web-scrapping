...
// JObsdescriptio with experencia
...
(function() {
    ...
    div.innerHTML =  full_html.trim();
    job.experience_required = tagExperienceRequired(div);
    //----------------------------------------------------- 
  
    job.html = full_html.trim();
  
    job.html = removeTextBefore(job.html, "Position Summary", false);
    job.html = removeTextAfter(job.html, "About UTA", true);
