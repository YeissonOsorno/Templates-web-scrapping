/*
* Template for json GET without ajax and without pagination
*/
...
var out = {};
    ...
    var element = document.querySelector("pre").textContent;
    var json = JSON.parse(element);
    var expected_jobs_str = json.SelectorExpectedJobs;
...
for(var i in jobs) {
    var job = {};    
    let elem = jobs[i]  
    job.title = elem.selectorTitle;
    job.url   = elem.selectorUrl;
    job.location = elem.selectorLocation;
