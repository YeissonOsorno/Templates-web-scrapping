(function() {
 ...
 //var iframeDocument = document.querySelector('#').contentWindow.document;//Obtener el html del iframe apartir del selector.
     ...
     /*let auxJobType = elem.querySelector('ul.positionDetails li:last-child').textContent.trim();
        if(auxJobType.search(/full time|part time|cda|ccd|time|permantent/i)>-1){
